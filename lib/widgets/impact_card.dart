...
class ImpactCard extends StatelessWidget {
  ...
  String _formatNumber(int number) {
    ...
    if (number >= 1000000) {
      return '${(number / 1000000).toStringAsFixed(0)} mln';
    }
    if (number >= 1000) {
                ...
                children: [
                  Expanded(
                    child: _ImpactItem(
                      ...
                      value: _formatNumber(AppConstants.totalTreesUzbekistan),
                    ),
                  ),
                  Container(width: 1, height: 40, color: Colors.white24),
                  Expanded(
                    child: _ImpactItem(
                      icon: '🏦',
                      label: 'Jamg\'arma',
                      value: '${_formatNumber(AppConstants.totalFundUzbekistan)} so\'m',
                    ),
                  ),
                ],
              ),
