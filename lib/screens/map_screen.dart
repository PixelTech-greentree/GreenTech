...
class _MapScreenState extends State<MapScreen> {
  ...
  Future<void> _loadNearbyTrees() async {
    ...
    await context.read<AppState>().loadNearbyTrees();
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Masofa: ${tree.distanceMeters.toStringAsFixed(0)} m',
              ...
              children: [
                Expanded(
                  child: _InfoChip(
                    ...
                    label: 'Aniqlik',
                    value: '${(tree.confidence * 100).toStringAsFixed(1)}%',
                  ),
                ),
                ...
                Expanded(
                  child: _InfoChip(
                    ...
                    label: 'Masofa',
                    value: '${tree.distanceMeters.toStringAsFixed(0)} m',
                  ),
                ),
              ],
            ),
          ...
          body: Stack(
            children: [
                ...
                FlutterMap(
                  ...
                  children: [
                    TileLayer(
                      ...
                      userAgentPackageName: 'com.greenify.app',
                    ),
                    ...
                    // Nearby trees markers
                    MarkerLayer(
                      markers: appState.nearbyTrees.map((tree) {
                        return Marker(
                          point: LatLng(tree.centroidLat, tree.centroidLon),
                          width: 40,
                          height: 40,
                  ...
                  child: Center(
                    child: _locationError
                        ? Column(
                            ...
                            children: [
                              const Icon(Icons.location_off, size: 64, color: AppColors.textLight),
                              ...
                              const Text(
                                'Joylashuv ruxsatini bermasangiz,\nxarita to\'g\'ri ishlamaydi.',
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              '${appState.nearbyTrees.length} ta',
              ...
              Positioned(
                ...
                right: 16,
                bottom: 16,
                child: const ImpactCard().animate().slideY(begin: 0.5, end: 0, delay: 300.ms),
              ),
                    ...
                    child: Container(
                      ...
                      child: const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Daraxtlar yuklanmoqda...', style: TextStyle(fontSize: 13)),
                        ],
                      ),
                    ),
                  ),
