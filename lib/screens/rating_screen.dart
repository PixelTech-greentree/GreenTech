    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            Text('${user.tasksCompleted} vazifa', style: const TextStyle(fontSize: 13, color: AppColors.textMedium)),
            const SizedBox(width: 8),
            Text('• ${user.treesPlanted} daraxt', style: const TextStyle(fontSize: 13, color: AppColors.textMedium)),
          ]),
        ])),
