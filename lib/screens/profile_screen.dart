      ...
      builder: (context, shopState, child) {
        return Scaffold(
          ...
          body: shopState.orders.isEmpty
              ...
              : ListView.builder(
                  padding: const EdgeInsets.all(20),
                  itemCount: shopState.orders.length,
                  itemBuilder: (context, index) {
                    final order = shopState.orders[index];
                    return Container(
                        ...
                        children: [
                          Row(
                            children: [
                              Expanded(
                                child: Text(
                                  'Buyurtma #${order.id.substring(3, 11)}',
                                  style: const TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.w700,
                                    color: AppColors.textDark,
                          ...
                          ...order.items.map((item) => Padding(
                                ...
                                child: Row(
                                  children: [
                                    Expanded(
                                      child: Text(
                                        '${item.item.nameUz} x${item.quantity}',
                                        style: const TextStyle(
                                          fontSize: 14,
                                          color: AppColors.textDark,
                                        ),
...
// CartScreen import from shop_screen.dart